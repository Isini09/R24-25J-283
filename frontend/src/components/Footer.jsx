  ...
  return (
    <div className="flex flex-col w-screen px-6 py-1 bg-white">
      <ul className="flex justify-end m-5 gap-9">
        <li className="font-mono text-2xl font-semibold text-green-600 grow">
          Cyber Seeds
        </li>
        ...
        <li>
          <a
            herf="#"
            className="px-6 py-2 border border-green-700 rounded-md hover:bg-green-600 hover:text-white"
          >
            Sign Up
          </a>
        </li>
