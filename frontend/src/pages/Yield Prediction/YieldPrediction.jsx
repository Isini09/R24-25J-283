        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 bg-gray-800 border border-gray-700 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full px-4 py-3 font-medium text-white transition-colors duration-200 bg-green-600 rounded-lg hover:bg-green-700 disabled:bg-gray-600"
                >
                  {!uploadedFile ? "Uploading..." : "Upload Image"}
                </button>
                {uploadedFile && (
            ...
            <button
              ...
              className="w-full px-6 py-4 text-lg font-bold text-white transition-colors duration-200 transform bg-green-600 rounded-lg hover:bg-green-700 disabled:bg-gray-600 hover:scale-105"
            >
              {predictionData === "" ? "Analyzing..." : "Get Prediction"}
            </button>
          </div>
        </div>
      </div>
