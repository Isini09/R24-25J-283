...
import { ChevronRight, Shield, Eye, Cpu, BarChart3, Leaf, Zap, Globe, Lock, Scan, Database, QrCode, CloudRain, TrendingUp, MapPin, Users, CheckCircle, ArrowRight, Wifi, Thermometer, Droplets, Wind, Sun, Activity, TreePine, Factory, Car, Recycle, Target, Award } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen overflow-hidden text-white bg-gradient-to-br from-black to-black">
      ...
      <nav className="fixed top-0 z-50 w-full px-6 py-4 border-b bg-black/80 backdrop-blur-lg border-white/10">
        <div className="container flex items-center justify-between mx-auto">
          ...
          <div className="hidden space-x-8 md:flex">
            <a href="#hero" className="transition-colors hover:text-green-600">Home</a>
            <a href="#passport" className="transition-colors hover:text-green-600">Digital Passport</a>
            <a href="#iot" className="transition-colors hover:text-green-600">IoT Devices</a>
            <a href="#carbon" className="transition-colors hover:text-green-600">Carbon Tracking</a>
            <a href="#twin" className="transition-colors hover:text-green-600">Digital Twin</a>
            <a href="#prediction" className="transition-colors hover:text-green-600">AI Prediction</a>
          </div>
        </div>
      </nav>
        ...
        <div className="container relative z-10 px-6 mx-auto text-center">
          <div className={`transition-all duration-1000 transform ${isVisible.hero ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
            ...
            <p className="max-w-4xl mx-auto mb-12 text-xl leading-relaxed text-gray-300 md:text-2xl">
              ...
              with blockchain-secured authenticity, IoT monitoring, carbon tracking, and AI-powered predictions.
            </p>
      ...
      <section id="iot" className="relative py-20">
        ...
        <div className="container relative z-10 px-6 mx-auto">
          <div className={`transition-all duration-1000 transform ${isVisible.iot ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
            <div className="mb-16 text-center">
              ...
              <p className="max-w-4xl mx-auto text-xl leading-relaxed text-gray-300">
                Deploy intelligent sensor networks across your agricultural operations. Monitor critical 
                environmental parameters in real-time, optimize resource usage, and make data-driven 
                decisions with our comprehensive IoT ecosystem.
              </p>
            </div>
            ...
            <div className="p-8 mb-16 border bg-gradient-to-br from-blue-600/20 to-green-600/20 rounded-3xl border-white/20">
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-3xl font-bold text-blue-400">Live IoT Dashboard</h3>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {iotDevices.map((device, index) => (
                  <div key={index} className="p-6 transition-all border bg-white/10 backdrop-blur-lg rounded-xl border-white/20 hover:bg-white/20">
                    <div className="flex items-center justify-between mb-4">
                      <device.icon className={`w-8 h-8 ${device.color}`} />
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                        <span className="text-sm text-green-400">{device.status}</span>
                      </div>
                    </div>
                    <h4 className="mb-2 text-lg font-semibold">{device.title}</h4>
                    <p className="mb-3 text-sm text-gray-400">{device.desc}</p>
                    <div className={`text-2xl font-bold ${device.color}`}>{device.value}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section id="carbon" className="relative py-20">
        ...
        <div className="container relative z-10 px-6 mx-auto">
          <div className={`transition-all duration-1000 transform ${isVisible.carbon ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
            <div className="mb-16 text-center">
              ...
              <p className="max-w-4xl mx-auto text-xl leading-relaxed text-gray-300">
                Track, monitor, and reduce your agricultural carbon footprint with precision. Our comprehensive 
                carbon tracking system helps you achieve sustainability goals while maintaining productivity 
                and profitability through smart environmental management.
              </p>
            </div>
            ...
            <div className="grid gap-8 mb-16 md:grid-cols-2 lg:grid-cols-4">
              {carbonMetrics.map((metric, index) => (
                <div key={index} className="p-6 transition-all border bg-white/5 backdrop-blur-lg rounded-2xl border-white/10 hover:bg-white/10 hover:scale-105">
                  <div className="flex items-center justify-between mb-4">
                    <metric.icon className="w-8 h-8 text-green-400" />
                    <div className={`text-sm px-2 py-1 rounded-full ${
                      metric.change.startsWith('+') ? 'bg-green-600/20 text-green-400' : 'bg-red-600/20 text-red-400'
                    }`}>
                      {metric.change}
                    </div>
                  </div>
                  <h3 className="mb-2 text-lg font-semibold">{metric.title}</h3>
                  <div className="mb-2 text-2xl font-bold text-green-400">{metric.value}</div>
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                <h3 className="mb-8 text-3xl font-bold text-green-400">Comprehensive Carbon Tracking</h3>
                <div className="space-y-6">
                  <div className="flex items-center gap-4 p-4 border bg-white/5 backdrop-blur-lg rounded-xl border-white/10">
                    <Target className="w-8 h-8 text-green-400" />
                    <div>
                      <h4 className="text-lg font-semibold">Emission Monitoring</h4>
                      <p className="text-gray-400">Real-time tracking of all carbon emission sources</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 border bg-white/5 backdrop-blur-lg rounded-xl border-white/10">
                    <TreePine className="w-8 h-8 text-green-400" />
                    <div>
                      <h4 className="text-lg font-semibold">Carbon Sequestration</h4>
                      <p className="text-gray-400">Measure carbon capture through soil and vegetation</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 border bg-white/5 backdrop-blur-lg rounded-xl border-white/10">
                    <Award className="w-8 h-8 text-green-400" />
                    <div>
                      <h4 className="text-lg font-semibold">Sustainability Certification</h4>
                      <p className="text-gray-400">Automated compliance reporting and certification</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 border bg-gradient-to-br from-green-600/20 to-blue-600/20 rounded-3xl border-white/20">
                <h4 className="mb-6 text-2xl font-bold text-center text-green-400">Carbon Reduction Progress</h4>
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="w-full h-3 overflow-hidden rounded-full bg-white/20">
                      <div className="h-full transition-all duration-1000 bg-gradient-to-r from-green-600 to-green-400" style={{width: '85%'}}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-2">
                    ...
                    <div className="w-full h-3 overflow-hidden rounded-full bg-white/20">
                      <div className="h-full transition-all duration-1000 bg-gradient-to-r from-blue-600 to-blue-400" style={{width: '72%'}}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-2">
                    ...
                    <div className="w-full h-3 overflow-hidden rounded-full bg-white/20">
                      <div className="h-full transition-all duration-1000 bg-gradient-to-r from-purple-600 to-purple-400" style={{width: '91%'}}></div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container px-6 mx-auto">
          <div className="grid gap-8 md:grid-cols-4">
            <div>
              ...
              <p className="text-gray-400">Revolutionizing agriculture through digital innovation, IoT monitoring, carbon tracking, and blockchain technology.</p>
            </div>
            <div>
